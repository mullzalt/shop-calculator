...
const translations = {
  id: {
    ...
    savedPrintFailed: 'Tersimpan! Gagal cetak.',
    retryPrint: 'Coba cetak lagi',
    done: 'Selesai',
    dataBackup: 'Backup Data',
    exportBackup: 'Ekspor Backup (.json)',
    importBackup: 'Impor Backup',
    importMerge: 'Gabung',
    importReplace: 'Ganti semua',
    importConfirmReplace: 'Semua data yang ada akan dihapus sebelum impor. Lanjutkan?',
    importSuccess: (c: number, tx: number) => `Berhasil impor: ${c} pelanggan, ${tx} transaksi`,
  ...
  en: {
    ...
    savedPrintFailed: 'Saved! Print failed.',
    ...
    importConfirmReplace: 'All existing data will be deleted before import. Continue?',
    importSuccess: (c: number, tx: number) => `Imported: ${c} customers, ${tx} transactions`,
